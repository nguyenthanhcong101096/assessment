 ...
 */
export const api_v1_signin_path: ((
 ...
 * @returns {string} route path
 */
export const api_v1_videos_path: ((
  options?: {format?: OptionalRouteParameter} & RouteOptions
) => string) & RouteHelperExtras;
 ...
 * @returns {string} route path
 */
export const myshare_videos_path: ((
  options?: {format?: OptionalRouteParameter} & RouteOptions
) => string) & RouteHelperExtras;
 ...
 * @returns {string} route path
 */
export const share_api_v1_videos_path: ((
  options?: {format?: OptionalRouteParameter} & RouteOptions
) => string) & RouteHelperExtras;
 ...
 * @returns {string} route path
 */
export const share_videos_path: ((
  options?: {format?: OptionalRouteParameter} & RouteOptions
) => string) & RouteHelperExtras;
